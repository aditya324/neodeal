    ...
    <div className="bg-cover bg-center bg-fixed" style={{ backgroundImage: `url(${login})` }}>
      ...
      <div className="min-h-screen flex justify-center items-center">
        <div className="bg-white mx-4 p-8 rounded-xl shadow-md w-full md:w-1/2 lg:w-1/3">
          ...
          <h1 className="text-2xl font-bold mb-8 text-center text-[#5356FB]">Reset Password</h1>
          <img src={logo} className='h-10'/>
          </div>
          <div className="flex items-center gap-2 mt-1">
                <img src={reset} className="h-5 w-5" alt="Reset icon" />
                <p className="text-sm">
                Please add email or phone number to reset your password
                </p>
              </div>
          <form>
            ...
            <div className='flex justify-center'>
                <p className='text-xl text-[#000000]'>or</p>
            </div>
            <div className="mb-4">
            ...
            <div className="mb-6">
              ...
              <Button name="Next" style="bg-[#5356FB] hover:bg-blue-600 text-white font-bold py-2 w-full rounded-full mt-6"/>
            </div>
          </form>
