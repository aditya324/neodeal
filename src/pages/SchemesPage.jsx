...
const SchemesPage = () => {
  ...
  <div className="lg:w-5/4 md:w-3/4">
    <div
      className="h-80 lg:h-full lg:w-full md:w-full w-80 rounded-2xl mx-auto"
      style={{
    ...
    >
      ...
      <div className='bg-[#DEDFF3] w-full h-52  '>
      <SchemeCard/>
        ...
        <div>
        <div>
            <p className='text-[#374557] font-semibold pl-20 pt-4 bg-[#DEDFF3] pb-5' >Prize Details</p>
        </div>
        <div className='flex justify-center items-center bg-[#DEDFF3] shadow-lg'>
          
          
          <div className='bg-[#EBE4FF] rounded-2xl overflow-hidden shadow-lg max-w-5xl lg:mx-0 mx-14 '>
  ...
  <div className="flex-shrink-0 flex justify-center md:justify-start lg:mb-5 p-4 md:p-0 md:pl-4">
    <img src={car} alt="car.png" className="lg:w-40 h-44 lg:h-36 object-cover md:w-48 md:h-48 rounded-2xl" />
  </div>
  <div className="flex flex-col justify-center p-4">
    <div className="mb-4">
      <p className="text-xl font-semibold">BMW CAR</p>
    </div>
    <ul className="list-disc pl-4 space-y-2">
      <li>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</li>
      <li>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled eggs.</li>
    </ul>
  </div>
</div>
...
<div>
  <BestSellerCard name="Products under scheme" style="text-[#374557] font-semibold lg:ml-20 pt-4" cardstyle="lg:pb-5"/>
</div>
