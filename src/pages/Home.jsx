        ...
        <div className="bg-custom-gradient w-full h-auto lg:h-96 flex flex-col md:flex-row lg:flex-row justify-start items-center gap-3 lg:px-7">
          ...
          >
            <div className="lg:ml-0 md:ml-5 ml-6">
              ...
              <p className="text-white lg:text-7xl font-extrabold my-2 text-4xl">
                WIN BIG!
              </p>
              <p className="text-white font-medium w-44 lg:w-80 md:w-40">
                ...
                <span className="block">
                  {" "}
                  unique number, unlocking the chance to
                </span>
            ...
            <div className="lg:mb-0 mb-0 md:mb-10">
              <img
                src={winnbg}
                alt=""
                className="lg:w-full lg:h-auto w-full h-full md:w-60 md:h-32 "
              />
          ...
          <div className="lg:mx-0 mx-10 md:mx-0 lg:mb-0 mb-10 lg:px-5 lg:mt-0 md:mt-10 md:px-5">
            <div
              className="w-80 h-auto lg:h-80 rounded-xl lg:py-0 py-5 lg:mr-16 md:mr-0 mr-0 lg:px-5"
            ...
            >
              <div className="flex flex-col items-center lg:py-10">
                ...
                <Button
                  ...
                  style="bg-[#5356FB] hover:bg-blue-600 text-white font-bold py-3 px-10 w-60 rounded-full mt-6"
                />
              </div>
            </div>
          </div>
