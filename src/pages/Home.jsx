...
const Home = () => {
  ...
  return (
    <>
      <div>
        <div className="bg-custom-gradient w-full h-auto lg:h-96 flex flex-col lg:flex-row justify-start items-center gap-3 lg:px-7">
          <div
            className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 p-5 rounded-2xl lg:h-auto   place-items-center w-full lg:w-5/6 md:w-5/6 lg:ml-12 md:ml-0 lg:px-10 "
            style={{
              backgroundImage: `url(${purbbg})`, backgroundSize: "cover",
        ...
        <BestSellerCard name="Best Seller" style="font-semibold text-[#374557] text-xl text-xl" className='lg:mt-10 '/>
